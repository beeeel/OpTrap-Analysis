public class Static_Image_Math{
    ...
    public static double[] getCentroidBasicSq(short[] pixels, int width, int height) {
    ...
    public static double[] getCentroidBasic(short[] pixels, int width, int height) {
...
public static double[] getTwoCentroidsBasicSq(short[] pixels, int width, int height) {
...
public static double[] getTwoCentroidsBasic(short[] pixels, int width, int height) {
        // Finds centroid for object based brightness
        // Get one centroid for left half of image and one for right half
        double mean;
        double[] CenterOfMass = {0, 0, 0, 0};
