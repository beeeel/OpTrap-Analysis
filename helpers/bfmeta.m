function [result] = bfmeta(id, varargin)
% Get metadata for microscopy images using Bio-Formats.
%
% SYNOPSIS r = bfmeta(id)
%          r = bfmeta(id, x, y, w, h)
%
% Input
%    id - path to the file
...
%    with a matrix representing the first image plane, and each inner
